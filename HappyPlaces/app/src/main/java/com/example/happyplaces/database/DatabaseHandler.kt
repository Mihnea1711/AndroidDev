...
class DatabaseHandler(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    fun addHappyPlace(happyPlace: HappyPlaceModel): Long {
        ...
        contentValues.put(KEY_IMAGE, happyPlace.imagePath) // HappyPlaceModelClass IMAGE
    ...
    fun updateHappyPlace(happyPlace: HappyPlaceModel): Int {
        ...
        // Updating Row
        val success = db.update(TABLE_HAPPY_PLACE, contentValues, KEY_ID + "=" + happyPlace.uid, null)
        //2nd argument is String containing nullColumnHack
    ...
    fun deleteHappyPlace(happyPlace: HappyPlaceModel): Int {
        val db = this.writableDatabase
        // Deleting Row
        val success = db.delete(TABLE_HAPPY_PLACE, KEY_ID + "=" + happyPlace.uid, null)
        //2nd argument is String containing nullColumnHack
        db.close() // Closing database connection
        return success
    }
