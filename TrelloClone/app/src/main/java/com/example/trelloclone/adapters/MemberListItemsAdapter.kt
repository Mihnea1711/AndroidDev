...
open class MemberListItemsAdapter(private val context: Context, private var list: ArrayList<User>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is MyViewHolder) {
            ...
            holder.itemView.findViewById<TextView>(R.id.tv_member_name).let {it.text = model.name}
            holder.itemView.findViewById<TextView>(R.id.tv_member_email).let{it.text = model.email}
