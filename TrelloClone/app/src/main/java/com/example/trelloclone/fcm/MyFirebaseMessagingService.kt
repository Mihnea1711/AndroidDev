...
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
        val channel = NotificationChannel(channelID, "Channel Trelol Title", NotificationManager.IMPORTANCE_DEFAULT)
...
//        }
    ...
    companion object {
        private const val TAG: String = "MyFirebaseMsgService"
    }
}